package com.miniproject.pantry.core.config;
...
import com.miniproject.pantry.core.auth.jwt.MyJwtAuthorizationFilter;
import com.miniproject.pantry.core.exception.Exception401;
import com.miniproject.pantry.core.util.MyFilterResponseUtil;
...
//        http.csrf().disable(); // postman 접근해야 함!! - CSR 할때!!
    ...
    public CorsConfigurationSource configurationSource() {
        ...
        configuration.addAllowedOriginPattern("http://Pantry1-env.eba-fdhbkdfm.ap-northeast-2.elasticbeanstalk.com"); // 모든 IP 주소 허용 (프론트 앤드 IP만 허용 react)
