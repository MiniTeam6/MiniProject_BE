...
import com.miniproject.pantry.PantryApplication;
import com.miniproject.pantry.core.MyRestDoc;
import com.miniproject.pantry.dto.event.EventRequest;
import com.miniproject.pantry.dto.event.EventRequest.EventAddInDto;
import com.miniproject.pantry.dto.event.EventRequest.EventCancelInDto;
import com.miniproject.pantry.dto.event.EventRequest.EventModifyInDto;
...
public class EventControllerTest extends MyRestDoc {
    ...
    public void event_add_annual_fail_test() throws Exception {
        ...
        resultActions.andExpect(jsonPath("$.errCode").value("1"));
